...
def main():
    ...
    if FLAGS.mode == 'imputation':
        ...
        imputed_interpolation_dataset = MisVal.impute_interpolate(copy.deepcopy(dataset), 'hr_watch_rate')
        imputed_quadratic_regression_dataset = MisVal.impute_quadratic_regression(copy.deepcopy(dataset), 'hr_watch_rate')

        DataViz.plot_imputed_values(dataset, ['original', 'quadratic_regression'], 'hr_watch_rate',
                                     imputed_quadratic_regression_dataset['hr_watch_rate'])
